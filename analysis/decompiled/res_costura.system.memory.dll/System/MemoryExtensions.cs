...
public static class MemoryExtensions
{
	...
	public static bool Overlaps<T>(this ReadOnlySpan<T> span, ReadOnlySpan<T> other)
	{
		...
		IntPtr intPtr = Unsafe.ByteOffset(in MemoryMarshal.GetReference(span), in MemoryMarshal.GetReference(other));
	...
	private unsafe static IntPtr MeasureStringAdjustment()
	{
		...
		{
			return Unsafe.ByteOffset(in Unsafe.As<Pinnable<char>>(text).Data, in Unsafe.AsRef<char>(source));
		}
	}
}
